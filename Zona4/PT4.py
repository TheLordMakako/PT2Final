...
path="PT4.py"        #Esta variable se tiene que cambiar dependiendo del codigo
CDMX='19.510761,-99.201414,11km' # geocode de longitud y latidud, circunferencia de 15 kilometros de radio
...
def PrimeraLectura(tema):
    ...
    carpeta=ruta+"C4/" + tema
    os.makedirs(carpeta, exist_ok=True)
    NomArchivo=carpeta+'/C4_'+tema+'.json'
    global data
    try:
...
def main():
                        ...
                        if ( tweetIn == 'tuits' or tweet.id != tweetIn["id"]):
                            ...
                            try:
                                ...
                                data['tuits'].append({
                                                ...
                                                'favorited': tweet.favorited,
                                                'retweeted': tweet.retweeted,
                                                'zona':'C4'    #este cambia dependiendo del circulo en donde se este trabajando
                                                })
    ...
    print("Termine todo el script PT4 exitosamente el: "+time.strftime('%Y-%m-%d %H:%M:%S', time.localtime()))
